...
import { Home, User, ShoppingCart, Cog, Star, MessageCircle } from "lucide-react";
  ...
  return (
    <nav className="bg-white shadow-md fixed w-full z-50">
      <div className="flex justify-between items-center px-6">
        ...
        {/* Buy Button */}
        <Link
          to={`/checkout?product=1&price=${basePrice}&quantity=1&name=${encodeURIComponent(" Low Carb Sugar Rice Cooker")}`}
